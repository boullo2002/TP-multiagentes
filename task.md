Consigna multiagentesIndividual Assessment - Multi-Agent Systems (2026 S1)
Context
...
1. Natural language query analysis and SQL execution support
...
1. Support iterative refinement via follow-up questions.
...
* final demo.
Reference:
* PostgreSQL Sample Database (Neon)
...
1. Short report (1-2 pages) explaining design choices and trade-offs.
Evaluation Rubric
