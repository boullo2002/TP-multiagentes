...
- [x] Agregar **diagrama de arquitectura** en `README.md` (requisito explícito).
- [x] Agregar diagramas de grafos (`query` y `schema`) en `README.md`.
- [x] Generar archivos separados de diagramas en `docs/diagrams/`.
- [x] Agregar **demo script reproducible** (README o archivo aparte) con:
  - [x] 1 sesión de schema con corrección humana,
  - [x] 3 consultas NL diferentes,
  - [x] 1 follow-up refinement,
  - [x] evidencia de ejecución sobre DVD Rental.
...
1. `REPORT.md`
2. Validación final de criterio docente sobre HITL en Query Agent
3. Revisión final de consistencia README/UI README/demo antes de entrega
